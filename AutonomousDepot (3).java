...
public class AutonomousDepot extends LinearOpMode
{
    ...
    private void centerPath(){
        unhook();
        DistanceFormula(1, 1, 2.5, 2.5, 'f', 'n');
        rotate(-45, power);
        dropmarker();
        sleep(700);
        DistanceFormula(2.5, 2.5, 2.5, 2.8, 'l', '*');
        sleep(200);
        hail_mary();
    ...
    private void leftPath(){
        unhook();
        DistanceFormula(1, 1, 1.2, 1.2, 'f', '*');
        DistanceFormula(1.2, 1.2, 0.95, 0.8, 'l', '*');
        DistanceFormula(0.95, 0.8, 1.5, 2.5, 'f', 'n');
        rotate(-45, power);
        DistanceFormula(1.5, 2.5, 2.5, 2.5, 'f', 'n');
        DistanceFormula(2.5, 2.5, 2.5, 2, 'r', 's');
        dropmarker();
        sleep(700);
        DistanceFormula(2.5, 2, 2.5, 2.25, 'b', 's');
        
        DistanceFormula(2.8, 2, 2.8, 2.5, 'l', '*');
        hail_mary();
