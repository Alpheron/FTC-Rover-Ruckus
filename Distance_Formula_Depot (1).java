...
@Autonomous(name = "1Distance_Formula_Depot", group = "Concept")

public class Distance_Formula_Depot extends LinearOpMode {
 ...
 private static final String VUFORIA_KEY = "";
    ...
    */
    ...
    private void centerpath() {
        ...
        DistanceFormula(2.75, 2.75, 3.4, 3.4, 'l');
          //turn1(20, 'l');
        sleep(100);
    ...
    private void leftpath() {
        ...
        sleep(100);
        DistanceFormula(1.2, 1.2, 0.9, 2, 'l');
        sleep(100);
        //turn1(17, 'r');
        ...
        turn1(55, 'r');
        sleep(100);
        DistanceFormula(1.5, 2.3, 1.5, 2.9, 'l');
        sleep(100);
    ...
    private void rightpath() {
        DistanceFormula(1, 1, 1.3, 1.3, 'f');
        sleep(100);
        DistanceFormula(1.2, 1.2, 1.9, 0.9, 'r');
        turn1(10, 'r');
        sleep(100);
        DistanceFormula(1.75, 0.75, 2.5, 2, 'f');
        sleep(100);
        turn1(45, 'l');
        sleep(100);
        ...
        DistanceFormula(2.75, 1.5, 2, 2, 'l');
        turn1(10, 'l');
        dropmarker();
        sleep(1000);
        // //moveuntildistance();
