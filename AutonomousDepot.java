...
public class Distance_Formula extends LinearOpMode {
    ...
    */
    ...
    private void centerpath() {
        ...
        DistanceFormula(2, 2, 2.75, 2, 'f');
       
        sleep(600);
        
        DistanceFormula(2.75, 2, 2.75, 2.25, 'l');
        sleep(100);
    ...
    private void leftpath() {
        DistanceFormula(1, 1, 0.9, 0.9, 'f');
        sleep(100);
        DistanceFormula(0.9, 0.9, 0.75, 1, 'l');
        sleep(100);
