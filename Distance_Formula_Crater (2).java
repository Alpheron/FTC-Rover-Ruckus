...
@Autonomous(name = "1Distance_Formula_Crater", group = "Concept")

public class Distance_Formula_Crater extends LinearOpMode {
 ...
 private static final String VUFORIA_KEY = "";
    ...
    double frontleftpower = 0.6;
    double backleftpower = 0.6;
    double frontrightpower = 0.6;
    double backrightpower = 0.6;
    ...
    */
    ...
    private void alignRobot(long time){
        frontleftmotor.setPower(0.4);
    ...
    private void headBack(){
        ...
        //DistanceFormula(2, 3, 2, 2.8, 'r');
        DistanceFormula(2, 1.5, -1, 2.5, 'b');
    }
    
    private void centerpath() {
        DistanceFormula(0.6, -0.8, 1.5, -1.5, 'f');
        //sleep(100);
        DistanceFormula(1.5, -1.5, 0.9, -0.9, 'b');
        sleep(100);
        turn1(90, 'l');
        sleep(100);
        DistanceFormula(0.8, -0.8, 2.7, 0.75, 'f');
        sleep(100);
        turn1(55, 'l');
        sleep(100);
        //DistanceFormula(2.7, 0.75, 2.7, 2.5, 'r');
        DistanceFormula(2.5, 0.5, 2.5, 2.75, 'f');
        sleep(100);
        dropmarker();
        sleep(100);
        DistanceFormula(2.5, 2.75, 2.5, 2.85, 'r');
        sleep(1000);
        //moveuntildistance();
        //stopMotor();
        headBack();
    ...
    private void leftpath() {
       DistanceFormula(0.6, -0.8, 1, -1, 'f');
        sleep(100);
        DistanceFormula(1, -1, 2.3, -0.9, 'l');
        sleep(100);
        DistanceFormula(1.5, -0.75, 2.3, -1, 'f');
        sleep(100);
        DistanceFormula(2, -1, 1.75, -0.75, 'b');
        sleep(100);
        turn1(100, 'l');
        sleep(100);
        DistanceFormula(1.75, -0.75, 2.5, 0.4, 'f');
        sleep(100);
        turn1(50, 'l');
        
        DistanceFormula(2.7, 0.4, 2.7, 2.7, 'f');
        sleep(100);
        //DistanceFormula(2.7, 2.7, 2.9, 2.7, 'r');
        sleep(1000);
        dropmarker();
        turn1(7, 'r');
        //moveuntildistance();
    ...
    private void rightpath() {
        DistanceFormula(0.6, -0.8, 1.1, -1.1, 'f');
        sleep(100);
        DistanceFormula(1.1, -1.1, 0.5, -1.8, 'r');
        sleep(100);
        DistanceFormula(0.5, -1.8, 1, -2.2, 'f');
        sleep(100);
        DistanceFormula(1, -2.2, 0.5, -1.8, 'b');
        sleep(100);
        turn1(85, 'l');
        sleep(100);
        DistanceFormula(0.5, -1.8, 2.5, 0.5, 'f');
        turn1(50, 'l');
        sleep(100);
        //DistanceFormula(2.5, 0.5, 2.8, 0.5, 'r');
        DistanceFormula(2.5, 0.5, 2.5, 2.75, 'f');
        sleep(100);
        dropmarker();
        //turn1(20, 'l');
